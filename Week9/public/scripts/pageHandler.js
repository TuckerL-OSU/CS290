...
// I was having trouble with my page handler, so I had to adapt my code to some examples I found online.
// Original comments left in to give author credit
// some sort of closure error with delete, but I cannot figure out how to fix it. Closure just makes no sense in any context to me
...
function deleteData(tableId, id) {                                //We need to create a function to delete data 
	...
	for(var i = 1; i < numRows; i++) {    	//Loop through the table for as many rows as there are
		var row = table.rows[i]; // might need to move
		(function(i) {
